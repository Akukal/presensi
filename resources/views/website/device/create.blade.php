@extends('website.layouts.app', ['title' => 'Add Device'])
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{ route('devices.store') }}">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select name="mode" class="form-control @error('mode') is-invalid @enderror">
                      ...
                      <option value="Reader" @selected(old('mode') == "Reader")>Reader</option>
                      <option value="Add_Card" @selected(old('mode') == "Add_Card")>Add Card</option>
                    </select>
                    @error('mode')
                      <span class="error invalid-feedback">{{ $message }}</span>
                    @enderror
