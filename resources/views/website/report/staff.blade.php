...
<script type="text/javascript">
  $(document).ready(function() {
    $('#datatable').DataTable({
      ...
      serverSide    : true,
      ajax          : {
          url     : '{!! route('reports.staff.ajax.datatable') !!}',
      },
      columns       : [
          {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
          {data: 'name', name: 'name', orderable: true, searchable: true},                    
          {data: 'gender', name: 'gender', orderable: true, searchable: true},                    
          {data: 'department.name', name: 'department.name', orderable: true, searchable: true},                    
          {data: 'position.name', name: 'position.name', orderable: true, searchable: true},                    
